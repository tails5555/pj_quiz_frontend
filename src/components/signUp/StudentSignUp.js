        ...
        return(
            <form>
                ...
                <div className="form-group">
                    ...
                    <input name="password_confirm" value='' id="password_confirm" placeholder="비밀번호를 다시 입력하세요." type="password" className="form-control" />
                </div>
                <div className="form-group">
                    <label for="name">이름</label>
                    <input name="name" value='' id="name" placeholder="이름을 입력하세요." type="text" className="form-control" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    <select name="gradeId" id="gradeId" value="" className="form-control">
                ...
                <div className="form-group">
                    <label for="password_in_school">학생용 확인 암호 입력</label>
