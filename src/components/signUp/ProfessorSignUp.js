    ...
    render(){
        return(
            <form>
                ...
                <div className="form-group">
                    <label for="spotId">직위</label>
                    <select name="spotId" id="spotId" value="" className="form-control">
                        <option value="1">대학원 조교</option>
                        <option value="2">조교수</option>
                        <option value="3">학과장</option>
                    </select>
                </div>
                <div className="form-group">
                    <label for="password_in_school">조교 / 교수용 확인 암호 입력</label>
